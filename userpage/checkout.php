                                ...
                                <form action="#">
                                    ...
                                    <div class="order_table table-responsive">
                                        <table>
                                            ...
                                            <tbody>
                                                <?php 
                                                    $arrProduct = array("Handbag fringilla",
                                                                        "Handbag justo",
                                                                        "Handbag elit",
                                                                        "Handbag Rutrum");
                                                    $arrPrice = array(165000,50000,500000,300000);
                                                    $total = 0;

                                                    for($i = 0; $i < count($arrProduct); $i++){
                                                        echo '<tr>
                                                            <td>'.$arrProduct[$i].'</td>
                                                            <td>'.number_format($arrPrice[$i],0,",", ".").'</td>
                                                        </tr>';
                                                        $total += $arrPrice[$i];
                                                    }
                                                ?>
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    <th>Shipping</th>
                                                    <?php
                                                        echo '<td><strong>' .number_format(10000,0,",", "."). '</strong></td>';
                                                    ?>
                                                </tr>
                                                <tr class="order_total">
                                                    <th>Order Total</th>
                                                    <?php
                                                        echo '<td><strong>' .number_format($total + 10000,0,",", "."). '</strong></td>';
                                                    ?>
                                                </tr>
                                            </tfoot>
                                        </table>
